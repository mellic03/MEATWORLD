...
//     // m_hinge_obj = idk::ECS2::createGameObject("Hinge");
//     // idk::ECS2::giveComponent<idk::TransformCmp>(m_hinge_obj);

//     // m_cam_obj = idk::ECS2::createGameObject("Camera");
//     // idk::ECS2::giveComponent<idk::TransformCmp>(m_cam_obj);

//     // int cam = ren.createCamera();
//     // ren.useCamera(cam);

//     // idk::ECS2::giveComponent<idk::CameraCmp>(m_cam_obj);
//     // idk::ECS2::getComponent<idk::CameraCmp>(m_cam_obj).cam_id = cam;


//     // idk::ECS2::giveChild(m_obj, m_hinge_obj);
//     // idk::ECS2::giveChild(m_hinge_obj, m_cam_obj);

//     // idk::TransformSys::translateLocalspace(m_cam_obj, glm::vec3(0.0f, 0.0f, 3.0f));


//     // idk::ECS2::giveComponent<idk::KinematicCapsuleCmp>(m_obj);
//     // auto &cmp = idk::ECS2::getComponent<idk::KinematicCapsuleCmp>(m_obj);
// }
...
//     // auto &T = idk::ECS2::getComponent<idk::TransformCmp>(m_obj);
