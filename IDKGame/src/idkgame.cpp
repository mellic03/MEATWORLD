...
void TaxEvasion::config()
{

}


void TaxEvasion::registerModules( idk::Engine &engine )
{
...
void TaxEvasion::setup( idk::Engine &engine, idk::RenderEngine &ren )
{
...
void TaxEvasion::mainloop( idk::Engine &engine, idk::RenderEngine &ren )
{
    auto &transCS = engine.getCS<Transform_CS>();
