...
void
Model_CS::init( idk::EngineAPI &api )
{
...
void
Model_CS::stage_A( idk::EngineAPI &api )
{
...
void
Model_CS::useModel( idk::RenderEngine &ren, int obj_id, int model_id )
{
...
idk::Model &
Model_CS::getModel( idk::RenderEngine &ren, int obj_id )
{
...
int
Model_CS::getAnimatorID( idk::RenderEngine &ren, int obj_id )
{
    int model_id = getModelID(obj_id);
...
idk::Animator &
Model_CS::getAnimator( idk::RenderEngine &ren, int obj_id )
{
